...
define('FIRST_NAME', 'eleklKKHG_88765GGhj_9iUUYhhgf_htge66');
define('MIDDLE_NAME', 'ookkjuHHYT_9823gyYYGf_kkjgtf_kjiUYT');
define('USER_NAME', 'dff_juHHYG_njhq_lkoyGF_yetGBVk_iju_ssh');
