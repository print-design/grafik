...
<html>
    <head>
        ...
        if($_SERVER['REQUEST_METHOD'] == 'POST' && isset($_POST['typography_create_submit'])) {
            if($_POST['laminator1_id'] == '') {
                $laminator1_id_valid = ISINVALID;
                $form_valid = false;
            }
            ...
            if($form_valid) {
                ...
                $sql = "insert into laminators"
                        . "(date, shift, laminator1_id, laminator2_id, organization_id, edition_id, length, lamination_id, roller, manager_id, comment) "
                        . "values "
                        . "($timestamp, '$shift', $laminator1_id, $laminator2_id, $organization_id, $edition_id, $length, $lamination_id, $roller, $manager_id, '$comment')";
            ...
            <div class="row">
                <div class="col-12 col-md-6">
                    ...
                    <div class="d-flex justify-content-between mb-2">
                        <div class="p-1">
                            <h1>Ламинаторы, создание рабочей смены</h1>
                        </div>
                        <div class="p-1">
                        ...
                        <div class="row">
                            <div class="col-12 col-md-6">
                                <div class="form-group">
                                    ...
                                    <div class="invalid-feedback">Ламинатор 1 обязательно</div>
                                </div>
                            </div>
                            <div class="col-12 col-md-6">
                                <div class="form-group">
