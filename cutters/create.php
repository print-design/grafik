    ...
    <head>
        ...
        if($_SERVER['REQUEST_METHOD'] == 'POST' && isset($_POST['typography_create_submit'])) {
            ...
            if($form_valid) {
                ...
                $sql = "insert into cutters"
                        . "(date, shift, cutter_id, organization_id, edition_id, length, lamination_id, roller, manager_id, comment) "
                        . "values "
                        . "($timestamp, '$shift', $cutter_id, $organization_id, $edition_id, $length, $lamination_id, $roller, $manager_id, '$comment')";
            ...
            <div class="row">
                <div class="col-12 col-md-6">
                    ...
                    <div class="d-flex justify-content-between mb-2">
                        <div class="p-1">
                            <h1>Резчики, создание рабочей смены</h1>
                        </div>
                        <div class="p-1">
                    ...
                    <form method="post">
                        ...
                        <div class="form-group">
                            ...
                            <textarea rows="5" id="comment" name="comment" class="form-control"><?=$_SERVER['REQUEST_METHOD'] == 'POST' && isset($_POST['comment']) ? htmlentities($_POST['comment']) : '' ?></textarea>
                        </div>
                        <div class="form-group">
