...
<html>
    <head>
            ...
            if($form_valid) {
                ...
                if ($conn->query($sql) === true) {
                    ...
                    if(isset($_POST['to']) && $_POST['to'] != '')
                        $period['to'] = $_POST['to'];
                    header('Location: '.APPLICATION.'/zbs3/?'. http_build_query($period));
                }
                else {
        ...
        if(!isset($_GET['from']) || !isset($_GET['to']) || !isset($_GET['id'])) {
            header('Location: '.APPLICATION.'/zbs3/');
        }
            ...
            <div class="row">
                <div class="col-12 col-md-6">
                    ...
                    <div class="d-flex justify-content-between mb-2">
                        <div class="p-1">
                            <h1>ZBS-3, редактирование рабочей смены</h1>
                        </div>
                        <div class="p-1">
                            <a href="<?=APPLICATION ?>/zbs3/?from=<?=$_GET['from'] ?>&to=<?=$_GET['to'] ?>" class="btn btn-outline-dark"><span class="font-awesome">&#xf0e2;</span>&nbsp;Отмена</a>
                        </div>
                    </div>
