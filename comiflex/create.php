    ...
    <head>
        ...
        if($_SERVER['REQUEST_METHOD'] == 'POST' && isset($_POST['typography_create_submit'])) {
            ...
            if($form_valid) {
                ...
                $sql = "insert into comiflex"
                        . "(date, shift, typographer_id, assistant_id, organization_id, edition_id, length, lamination_id, coloring, roller, manager_id) "
                        . "values "
                        . "($timestamp, '$shift', $typographer_id, $assistant_id, $organization_id, $edition_id, $length, $lamination_id, $coloring, $roller, $manager_id)";
            ...
            <div class="row">
                <div class="col-12 col-md-6">
                    ...
                    <div class="d-flex justify-content-between mb-2">
                        <div class="p-1">
                            <h1>Comiflex, создание рабочей смены</h1>
                        </div>
                        <div class="p-1">
