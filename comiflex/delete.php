    ...
    <head>
        ...
        if($_SERVER['REQUEST_METHOD'] == 'POST' && isset($_POST['typography_delete_submit'])) {
            if($form_valid) {
                ...
                $sql = "delete from comiflex where id=".$_POST['id'];
            ...
            <div class="row">
                <div class="col-12 col-md-6">
                    ...
                    <div class="d-flex justify-content-between mb-2">
                        <div class="p-1">
                            <h1>Comiflex, удаление рабочей смены</h1>
                        </div>
                        <div class="p-1">
                    ...
                    <table class="table table-bordered">
                        ...
                        <tr>
                            ...
                            <th>Помощник</th>
                            <td><?=$a_last_name.' '.(mb_strlen($a_first_name) > 1 ? mb_substr($a_first_name, 0, 1).'.' : $a_first_name).' '.(mb_strlen($a_first_name) > 1 ? mb_substr($a_middle_name, 0, 1).'.' : $a_middle_name) ?></td>
                        </tr>
                        <tr>
                            <th>Менеджер</th>
