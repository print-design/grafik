    ...
    <head>
        ...
        if($_SERVER['REQUEST_METHOD'] == 'POST' && isset($_POST['user_edit_submit'])) {
            ...
            if($form_valid) {
                ...
                $sql = "update user set last_name='$last_name', first_name='$first_name', middle_name='$middle_name', username='$username' where id=$id";
        ...
        $conn = new mysqli(DATABASE_HOST, DATABASE_USER, DATABASE_PASSWORD, DATABASE_NAME);
        $sql = "select last_name, first_name, middle_name, username from user where id=".$_GET['id'];
